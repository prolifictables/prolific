            ...
            <main className="flex-1 px-4 pt-4 space-y-4">
              ...
              <div className="rounded-3xl bg-gradient-sunset p-6 text-white shadow-glow-accent relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex flex-wrap gap-3 mt-4 text-xs text-white/90">
                    {data.tableName && (
                      <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/15 backdrop-blur border border-white/20">
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                          <path d="M3 10h18M3 14h18M5 6v14M19 6v14M4 20h16M10 6h4v4h-4z" />
                        </svg>
                        Table {data.tableName}
                      </span>
                    )}
                    {data.estimatedReadyMinutes && (
                      <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/15 backdrop-blur border border-white/20">
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                          <circle cx="12" cy="12" r="9" />
                          <path d="M12 7v5l3 3" />
                        </svg>
                        ~{data.estimatedReadyMinutes} min
                      </span>
                    )}
                  </div>
                </div>
              ...
              <LiveWhenCompleted>
                <div className="rounded-3xl bg-emerald-50 border border-emerald-200 p-6 text-center animate-scale-in">
                  ...
                  <div className="mt-5 grid grid-cols-1 gap-3">
                    ...
                    <Link
                      href="/"
                      className="w-full rounded-2xl border border-emerald-200 bg-white text-emerald-700 py-3.5 font-semibold hover:bg-emerald-50 transition"
                    >
                      Back to home
                    </Link>
                  </div>
