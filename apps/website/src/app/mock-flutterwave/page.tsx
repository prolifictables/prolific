...
export default function MockFlutterwavePage({
  ...
  const ref = searchParams?.ref || 'flw_test_ref';
  ...
  return (
    <div className="min-h-screen bg-[#F5A623]/10 flex flex-col px-4 py-8">
      <div className="mx-auto w-full max-w-sm">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-xl bg-[#F5A623] text-white flex items-center justify-center font-bold">
              F
            </div>
            <div>
              <p className="font-bold text-slate-800 leading-tight">Flutterwave</p>
        ...
        <div className="rounded-3xl bg-white shadow-card p-6 border border-slate-100">
          ...
          <div className="mt-6 space-y-3">
            <div className="rounded-xl bg-slate-50 p-3 text-xs space-y-2">
              ...
              <div className="flex justify-between text-slate-600">
                <span>Card</span>
                <span className="font-mono text-slate-700">•••• •••• •••• 0001</span>
              </div>
              <div className="flex justify-between text-slate-600">
                <span>Expiry</span>
                <span className="font-mono text-slate-700">09/27</span>
              </div>
            </div>
            ...
            <PrimaryButton
              fullWidth
              size="lg"
              className="!bg-[#F5A623] !hover:bg-[#E0971C]"
              onClick={() => go('success')}
            >
